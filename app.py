...
def draw_wbs(well, casing, shoes, geocalc, fitlot=None):
    """
    Stage 9:
    - remove separate Shoe/Top/TOC column
    - move Hole / Mud to the left side
    - combine FIT/LOT with casing specs on the right
    - improve top-of-liner depiction
    - remove casing-size labels from the middle of the wellbore
    """
    ...
    info_adj = adjust_positions(shoe_actual, min_sep=2100, ymin=header_y + 450, ymax=max_depth * 0.96)
