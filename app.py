...
def draw_3d_directional_wbs(well, survey, shoes, geocalc):
    """3D directional WBS using Easting, Northing and TVD."""
    ...
    # Casing strings along the 3D trajectory
    csort = shoes.sort_values('Shoe_MD_ft').reset_index(drop=True).copy()
    if not csort.empty:
...
with tab7:
    fig_3d = draw_3d_directional_wbs(well, survey, shoes, geocalc)
